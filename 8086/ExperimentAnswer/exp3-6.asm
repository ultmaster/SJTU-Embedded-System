...
; Get certain digit (BL) and place it in BH
GET_DIGIT PROC
   MOV AX, ExtraRegister
   MOV CL, 3
   SUB CL, BH
   SHL CL, 1
   SHL CL, 1
...
; DISPLAY_NUMBER [BL] ON [BH]
; BH should be between 0 and 3
; BL should be between 0 and 15
DISPLAY_NUMBER PROC
   MOV CL, BH
   MOV AL, 1
   SHL AL, CL
